...
const confusionMatrixData = [
  { predicted: "Bit 0", actual: "Bit 0", count: 5712, percentage: 95.23 },
  { predicted: "Bit 1", actual: "Bit 0", count: 286, percentage: 4.77 },
  { predicted: "Bit 0", actual: "Bit 1", count: 281, percentage: 4.68 },
  { predicted: "Bit 1", actual: "Bit 1", count: 5721, percentage: 95.32 },
]
          ...
          <TabsContent value="overview" className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Detailed breakdown of bit-level classification results</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold mb-3">Confusion Matrix Results</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                        <span className="text-sm">True Bit 0 → Predicted Bit 0</span>
                        <Badge variant="secondary">5712 (95.23%)</Badge>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded">
                        <span className="text-sm">True Bit 1 → Predicted Bit 1</span>
                        <Badge variant="secondary">5721 (95.32%)</Badge>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded">
                        <span className="text-sm">Misclassifications</span>
                        <Badge variant="destructive">567 (4.73%)</Badge>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center p-3 bg-muted rounded">
                        <span className="text-sm">Precision (Bit 0)</span>
                        <Badge variant="secondary">95.31%</Badge>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-muted rounded">
                        <span className="text-sm">Precision (Bit 1)</span>
                        <Badge variant="secondary">95.24%</Badge>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-muted rounded">
                        <span className="text-sm">F1-Score</span>
                        <Badge variant="secondary">95.27%</Badge>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <TabsContent value="results" className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Comprehensive analysis of your model's performance</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="mb-6">
                  <Image
